...
| [**VS Code extension**](vsc-ext.md) | The hmd preview, diagnostics, and the graph, inside the editor | `0.2.0` live on both galleries, still labelled a preview release | The graph tab — the feature the preview label waits on |
